/**
 * Lista de países com DDI (código de discagem internacional E.164) e nome em
 * português. A bandeira é derivada do código ISO-3166 alpha-2 em runtime
 * (emoji de indicadores regionais), então não armazenamos imagem nenhuma.
 *
 * Ordenada alfabeticamente por nome. O seletor de telefone usa este dataset
 * para permitir QUALQUER país.
 */

export type Country = {
  /** ISO-3166 alpha-2, ex.: "BR" */
  iso2: string;
...
/** Emoji de bandeira a partir do código ISO-2 (regional indicator symbols). */
...
export const COUNTRIES: Country[] = [
  ...
  { iso2: "BF", name: "Burquina Faso", dial: "226" },
  ...
  { iso2: "KY", name: "Ilhas Cayman", dial: "1345" },
  { iso2: "FO", name: "Ilhas Faroé", dial: "298" },
  { iso2: "VG", name: "Ilhas Virgens Britânicas", dial: "1284" },
  { iso2: "VI", name: "Ilhas Virgens Americanas", dial: "1340" },
...
/** Busca por nome ou DDI (com ou sem "+"). */
